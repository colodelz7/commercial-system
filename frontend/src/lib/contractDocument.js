...
export function renderContractHTML(c, cd, services) {
  ...
  h += '<div class="ct-cover">'
    + '<div class="ct-cover-logo">Morning</div>'
  ...
  h += pb('11.6. A CONTRATANTE declara estar ciente de que, ao contratar a CONTRATADA, está contratando a prestação técnica, estratégica, criativa e operacional dos serviços, bem como a aplicação da propriedade intelectual, conhecimento, metodologia, experiência, critério técnico, processos internos e forma de execução da equipe da Morning, os quais pertencem exclusivamente à CONTRATADA.');
